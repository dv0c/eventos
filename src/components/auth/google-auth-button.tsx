...
function GoogleGlyph({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden>
      ...
      <path
        fill="#EA4335"
        d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.07 1 3.11 3.94 1.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 7.16-4.53z"
      />
    </svg>
  );
}
...
export function GoogleAuthButton({ callbackUrl = "/dashboard" }: GoogleAuthButtonProps) {
  ...
  return (
    ...
    >
      ...
      {isLoading ? `${t("continueWithGoogle")}...` : t("continueWithGoogle")}
    </Button>
  );
}
